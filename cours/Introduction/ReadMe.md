...
Cela fonctionne-t-il toujours si, au lieu d'avoir un nom utilisant des lettres anglaises comme Alice, l'élève a un nom en caractères cyrilliques, arabes, ou chinois par exemple ?
