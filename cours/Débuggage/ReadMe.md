...
Après avoir ajouté cet invariant, notez que `top -= 1` dans `pop` peut briser l'invariant puisqu'il est utilisé inconditionnellement. Il en va de même pour `top += 1` dans `push`.
